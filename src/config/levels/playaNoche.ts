...
export const playaNocheLayout: StageLayoutConfig = {
  ...
  breakableProps: [
    { id: "table_1", textureKey: "prop_crate", x: 870, y: 216, originX: 0.5, originY: 1, scale: 1, maxHp: 24, points: 150, dropType: "small_heal", dropChance: 0.55, healAmount: 16 },
    { id: "table_2", textureKey: "prop_crate", x: 1610, y: 216, originX: 0.5, originY: 1, scale: 1, maxHp: 24, points: 150, dropType: "medium_heal", dropChance: 0.3, healAmount: 28 },
  ],
  collisionFootprints: [
