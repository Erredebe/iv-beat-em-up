...
export const playaNocheLayout: StageLayoutConfig = {
  ...
  breakableProps: [
    { id: "table_1", textureKey: "prop_crate", x: 870, y: 216, originX: 0.5, originY: 1, scale: 1, maxHp: 24, points: 150, dropType: "small_heal", dropChance: 1, healAmount: 34 },
    { id: "table_2", textureKey: "prop_crate", x: 1610, y: 216, originX: 0.5, originY: 1, scale: 1, maxHp: 24, points: 150, dropType: "medium_heal", dropChance: 0.95, healAmount: 52 },
    { id: "table_3", textureKey: "prop_crate", x: 520, y: 216, originX: 0.5, originY: 1, scale: 1, maxHp: 22, points: 130, dropType: "small_heal", dropChance: 0.78, healAmount: 28 },
    { id: "table_4", textureKey: "prop_crate", x: 1260, y: 216, originX: 0.5, originY: 1, scale: 1, maxHp: 22, points: 130, dropType: "small_heal", dropChance: 0.82, healAmount: 30 },
  ],
  collisionFootprints: [
