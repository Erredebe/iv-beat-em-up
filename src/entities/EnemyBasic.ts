...
export function buildEnemyAttackData(
  ...
  const enemyVisualClipId: AttackVisualClipId =
    archetype === "mini_boss" ? "attack3" : archetype === "bat_wielder" ? "attack2" : "attack1";
  const enemyBase = {
    ...source.ATTACK_1,
    totalFrames: archetype === "mini_boss" ? 28 : archetype === "bat_wielder" ? 24 : 22,
    activeStart: archetype === "rusher" || archetype === "agile_f" ? 6 : 8,
    activeEnd: archetype === "mini_boss" ? 13 : 10,
    recoveryStart: archetype === "mini_boss" ? 14 : 11,
    ...
    hitbox: {
      ...
      offsetY: -58,
      width: archetype === "mini_boss" ? 46 : archetype === "bat_wielder" ? 38 : 28,
      height: 26,
    },
  };
